...
export const PinContainer = ({
  ...
  const onMouseEnter = () => {
    setTransform("translate(-40%,-40%) rotateX(40deg) scale(0.8)");
  };
  const onMouseLeave = () => {
  ...
  return (
    <a
      ...
      <div
        style={{
          perspective: "1000px",
          transform: "rotateX(90deg) translateZ(90deg)",
        }}
        ...
        <div
          ...
          className="absolute w-90  p-4   flex justify-start items-start  rounded-2xl h-96  shadow-[0_8px_16px_rgb(0_0_0/0.4)] bgborder border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden">
      ...
      <div className=" w-full h-full mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          <a
            href={href}
            target={"_blank"}
            className="relative bottom-54 rounded-3xl text-black  flex space-x-2 items-center z-10   py-0.5 px-4   ">
            <span
              className="relative z-20 text-blue-900     text-xs font-mono p-3 inline-block py-0.5">
              {title}
            </span>
