...
export default function ManageProjects() {
  ...
  {editProject && (
    ...
    >
      <motion.div
        ...
        className="bg-[#0C226B] text-white rounded-2xl p-6 w-full max-w-3xl shadow-xl space-y-6 overflow-y-auto max-h-[90vh]"
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          {/* Location */}
          <div className="flex flex-col">
            <label className="text-sm text-orange-300 mb-1">Location</label>
            <input
              type="text"
          ...
          <div className="col-span-full flex flex-col">
            <label className="text-sm text-orange-300 mb-1">Description</label>
            <textarea
              rows="4"
          ...
          {/* Area */}
          <div className="flex flex-col">
            <label className="text-sm text-orange-300 mb-1">Area (sq.ft)</label>
            <input
              type="number"
          ...
          {/* Duration */}
          <div className="flex flex-col">
            <label className="text-sm text-orange-300 mb-1">Duration</label>
            <select
              value={editProject.duration || ""}
              onChange={(e) =>
                setEditProject({ ...editProject, duration: e.target.value })
              }
              className="bg-white/10 border border-orange-400/40 text-white rounded-lg p-2 text-sm focus:ring-2 focus:ring-orange-400"
            >
              <option value="">Select Duration</option>
  ...
  <datalist id="type-options">
    ...
    <option value="Renovation" />
          ...
          {/* Image Upload */}
          <div className="col-span-full flex flex-col">
            <label className="text-sm text-orange-300 mb-2">Upload Image</label>
            <div className="flex flex-col items-center justify-center border-2 border-dashed border-orange-400 rounded-lg p-4 bg-white/5 hover:bg-white/10 transition cursor-pointer">
              ...
              {editProject.preview ? (
                <img
                  ...
                  alt="Preview"
                  className="mt-3 w-32 h-32 sm:w-40 sm:h-40 object-cover rounded-lg border border-orange-400/30"
                />
              ) : editProject.image && typeof editProject.image === "string" ? (
                <img
                ...
                <p className="text-xs text-gray-300 mt-2">No image selected</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 flex flex-col sm:flex-row justify-end gap-3">
          <button
            ...
            className="px-4 py-2 bg-gray-500 hover:bg-gray-600 rounded-lg transition w-full sm:w-auto"
          >
            Cancel
          </button>
          <button
            onClick={handleEditSave}
            className="px-4 py-2 bg-orange-500 hover:bg-orange-600 rounded-lg transition w-full sm:w-auto"
          >
            Save Changes
          </button>
        </div>
